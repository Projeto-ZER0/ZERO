...
function cadastrarTier(req, res) {
    // Crie uma variável que vá recuperar os valores do arquivo cadastro.html
    var FitaFav = req.body.FitaServer;
    var PersonagemFav = req.body.PersonagemServer;
    var fkUsuarioT = req.body.fkUsuarioServer;
    ...
    if (Acertos > 10) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrarTier(FitaFav, PersonagemFav, fkUsuarioT)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
